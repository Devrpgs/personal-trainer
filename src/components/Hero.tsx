...
const Hero = () => {
  return (
    <section id="home" className="hero-section relative min-h-screen flex items-center py-20 text-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button className="btn-primary text-lg group transition-all duration-300 transform hover:scale-105" size="lg">
          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3"
                alt="Robson Porto, Personal Trainer" 
                className="w-full max-w-md mx-auto rounded-lg shadow-xl relative z-10 border-4 border-white/20 hover:scale-105 transition-all duration-500"
              />
            </div>
          </div>
        </div>
